...
inline __m128d _mm_set1_pd(real _w)
{
	return vdupq_n_f64(_w);
}
...
{
	return (__m128d)vandq_s64((int64x2_t)a,(int64x2_t)b);
}
...
{
    return (__m128d)veorq_s64((int64x2_t)a, (int64x2_t)b);
}
...
inline __m128d _mm_min_pd(__m128d a , __m128d b )
{
...
inline __m128d _mm_cmpgt_pd(__m128d a, __m128d b )
{
	return (__m128d)vcgtq_f64(a,b);
}
...
//Warning!!! Below functions did not test yet. They should not work normal.
//Please rewrite it when you get the aarch64 demo card.
